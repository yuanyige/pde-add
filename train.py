...
def run_standard(model):
    ...
    for epoch in range(start_epoch, args.epoch + start_epoch):
        ...
        # test for nat
        eval_nat_metric = test_ensemble(dataloader_test, model, ensemble_iter=args.ensemble_iter_eval, device=device)
        
        # test for ood
        eval_ood_metric = test_ensemble(dataloader_test_ood, model, ensemble_iter=args.ensemble_iter_eval, device=device)
