...
def create_attack(model, attack_type, attack_eps, attack_iter, attack_step, rand_init_type='uniform', 
                  clip_min=0., clip_max=1. ,save_path=None):
    """
   ...
   """
    ...
    if attack_type == 'fgsm':
        ...
        attack = LinfPGDAttack(model, criterion, eps=attack_eps, nb_iter=attack_iter, eps_iter=attack_step,
                               rand_init_type=rand_init_type, clip_min=clip_min, clip_max=clip_max, save_path=save_path)
